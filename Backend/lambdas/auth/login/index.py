...
import os
import traceback
from schemas import UserLogin, Token, ErrorResponse
from auth import verify_password, create_access_token, create_refresh_token, ACCESS_TOKEN_EXPIRE_MINUTES
...
def lambda_handler(event, context):
    ...
    try:
        ...
        # Store refresh token
        refresh_token_id = create_refresh_token_db(user['Email'], user_data.device_id)
